...
Only requiring some minor changes is onex.cpp.
...
Changes to onex.cpp
----------------------
onex.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
