    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Onex Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Onex Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  onex-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Onex in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ONEX, 0.1 ONEX, 1 ONEX and 10 ONEX -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://onexcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://onexcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Onex Core is shutting down...") + "<br /><br />" +
