    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Onex Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Onex address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and onex: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Onex Core"), this);
    aboutAction->setStatusTip(tr("Show information about Onex Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Onex Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Onex addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Onex addresses"));
    ...
    openAction->setStatusTip(tr("Open a onex: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Onex Core help message to get a list with possible Onex Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Onex Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Onex network", "", count));
}
...
{
    QString strTitle = tr("Onex Core"); // default title
